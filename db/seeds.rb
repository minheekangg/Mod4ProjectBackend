...
g = Letter.create(name: '1-g', image:'https://github.com/minheekangg/Mod4ProjectBackend/blob/master/app/assets/images/g.png', game_id: game.id)
n = Letter.create(name: '2-n', image:'https://github.com/minheekangg/Mod4ProjectBackend/blob/master/app/assets/images/n.png', game_id: game.id)
d = Letter.create(name: '3-d', image:'https://github.com/minheekangg/Mod4ProjectBackend/blob/master/app/assets/images/d.png', game_id: game.id)
r = Letter.create(name: '4-r', image:'https://github.com/minheekangg/Mod4ProjectBackend/blob/master/app/assets/images/r.png', game_id: game.id)
m = Letter.create(name:'5-m', image:'https://github.com/minheekangg/Mod4ProjectBackend/blob/master/app/assets/images/m.png', game_id: game.id)
b = Letter.create(name: '6-b', image:'https://github.com/minheekangg/Mod4ProjectBackend/blob/master/app/assets/images/b.png', game_id: game.id)
